...
The ImagineArt SDK provides integration with [Microsoft.Extensions.AI](https://learn.microsoft.com/en-us/dotnet/ai/microsoft-extensions-ai), enabling seamless interoperability with the unified .NET AI abstractions.

## Installation

```bash
dotnet add package ImagineArt
```
...
using var client = new ImagineArtClient(
    apiKey: Environment.GetEnvironmentVariable("IMAGINEART_API_KEY")!);
