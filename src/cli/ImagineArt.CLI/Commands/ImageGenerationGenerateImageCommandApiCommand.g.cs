...
internal static partial class ImageGenerationGenerateImageCommandApiCommand
{
    ...
    private static Option<global::ImagineArt.ImageStyle> Style { get; } = new(
        name: @"--style")
    {
        Description = @"ImagineArt style identifier.",
        DefaultValueFactory = _ => global::ImagineArt.ImageStyle.ImagineTurbo,
    };
...
Generate an image from a text prompt and ImagineArt style.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            ...
            {
                        var __requestBase = await CliRuntime.ReadRequestOrDefaultAsync<global::ImagineArt.GenerateImageRequest>(
                            parseResult,
                            Input,
                            RequestJson,
                            RequestFile,
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ImageGeneration.GenerateImageAsync(
                                    prompt: prompt,
                                    style: style,
