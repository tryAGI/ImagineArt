...
namespace ImagineArt.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "ImagineArt.CLI";
    private const string UserSecretApiKeyName = "IMAGINEART_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"IMAGINEART_API_KEY"];
    private const string CredentialFileDirectoryName = ".imagine-art";

    public static async global::System.Threading.Tasks.Task<global::ImagineArt.ImagineArtClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::ImagineArt.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::ImagineArt.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::ImagineArt.ImagineArtClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::ImagineArt.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::ImagineArt.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::ImagineArt.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::ImagineArt.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("IMAGINEART_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::ImagineArt.ApiException exception)
    {
        var builder = new StringBuilder();
