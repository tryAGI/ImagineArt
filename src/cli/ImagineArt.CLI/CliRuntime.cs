...
internal static class CliRuntime
{
    ...
    public static async Task<global::ImagineArt.ImagineArtClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::ImagineArt.ApiException exception)
    {
        var builder = new StringBuilder();
